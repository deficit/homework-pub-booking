    ...
    with example_sessions_dir("ex5-edinburgh-research", persist=real) as sessions_root:
        session = create_session(
            ...
            task=(
                ...
                "HARD RULES (Failure to follow these will result in termination):\n"
                "  - Do NOT change the party_size from 6. You must use 6.\n"
                "  - Do NOT change the near parameter from 'Haymarket'. You must search exactly for 'Haymarket'.\n"
                "  - Do NOT call handoff_to_structured under any circumstances. You must complete the task yourself.\n\n"
